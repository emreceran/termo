...
class WebsiteSaleForm(WebsiteForm):
    ...
    @http.route([
        '/urun_secme_prod',
        '/urun_secme_prod/page/<int:page>',
        '/urun_secme_prod/category/<model("product.public.category"):category>',
        '/urun_secme_prod/category/<model("product.public.category"):category>/page/<int:page>',
    ...
    def shop(self, page=0, category=None, search='', min_price=0.0, max_price=0.0, ppg=False, **post):
        ...
        keep = QueryURL('/urun_secme_prod',
                        **WebsiteSale._shop_get_query_url_kwargs(self, category and int(category), search, min_price, max_price, **post))
        ...
        options = WebsiteSale._get_search_options(self,
            category=category,
        ...
        fuzzy_search_term, product_count, search_product = WebsiteSale._shop_lookup_products(self, attrib_set, options, post, search,
                                                                                      website)
        ...
        if category:
            url = "/urun_secme_prod/category/%s" % slug(category)
        ...
        values = {
            ...
            'bins': lazy(lambda: WebsiteSale.TableCompute().process(products, ppg, ppr)),
            'ppg': ppg,
            'ppr': ppr,
            'categories': categs,
        ...
        values.update(WebsiteSale._get_additional_shop_values(self, values))
